...
/**
 * Default audio dvice error.
 *
 * @author Anton
 * @version 1.0
 */
public class AudioDeviceException extends AudioEngineException {
    /**
     ...
     * @since 1.7
     */
    public AudioDeviceException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
